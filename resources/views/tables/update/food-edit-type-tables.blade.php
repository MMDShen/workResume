                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body px-0 pt-0 pb-2">
                            <div class="table-responsive p-0">
                                <div class="card-body px-0 pt-0 pb-2">
                                    <form action="{{ url('food-type-table/'.$id) }}" method="POST">
                                        @csrf
                                        @method('PATCH')
                                        @if($errors->any())
                                        ...
                                        <div class="row">
                                            <div class="">
                                                <div class="form-group">
                                                    <label for="user-name"
                                                           class="form-control-label">{{ __('Food Type') }}</label>
                                                    <div
                                                        class="@error('type')border border-danger rounded-3 @enderror">
                                                        <input class="form-control" value="{{ \App\Models\FoodType::find($id)->type }}"
                                                               type="text"
