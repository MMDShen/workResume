                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body px-0 pt-0 pb-2">
                        <div class="table-responsive p-0">
                            <div class="card-body px-0 pt-0 pb-2">
                                <form action="{{ url('food-discount-table/'.$id) }}" method="POST">
                                    @csrf
                                    @method('PATCH')
                                    @if($errors->any())
                            ...
                            {{ session('success') }}</span>
                                        ...
                                        <div class="">
                                            <div class="form-group">
                                                ...
                                                <div
                                                    ...
                                                    <input class="form-control" value="{{ \App\Models\FoodDiscount::find($id)->label }}"
                                                           type="text"
                                        ...
                                        <div class="">
                                            <div class="form-group">
                                                ...
                                                <div
                                                    ...
                                                    <input class="form-control" value="{{ \App\Models\FoodDiscount::find($id)->factor }}"
                                                           type="text"
                                    ...
                                    <a class="justify-content-center m-auto d-flex" href="/food-discount-table">last page</a>
                                </form>
                            </div>
                        </div>
                    </div>
