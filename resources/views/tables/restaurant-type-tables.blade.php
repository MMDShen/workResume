                ...
                <div class="col-12">
                    <div class="card mb-4">
                        ...
                        <div class="card-body px-0 pt-0 pb-2">
                            ...
                            <form class="m-auto w-75 justify-content-center d-flex"
                                  action="{{ url('restaurant-type-table/') }}" method="POST">
                                @csrf
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex px-2 py-1 justify-content-center">
                                                        <div class="d-flex flex-column justify-content-left">
                                                            <p class="mb-0 text-sm">{{$type->type}}</p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="d-flex px-2 py-1 justify-content-center">
                                                        <div class="d-flex px-2 py-1 justify-content-center">
                                                            ...
                                                            <div class="d-flex flex-column justify-content-center">
                                                                <a href="{{ url('/restaurant-type-table/edit/'.$type->id) }}"
                                                ...
                                                <td>
                                                    <div class="d-flex px-2 py-1 justify-content-center">
                                                        ...
                                                        <form action="{{ url('restaurant-type-table/'.$type->id) }}"
                                                              method="POST">
                                                            @csrf
                                                            @method('DELETE')
