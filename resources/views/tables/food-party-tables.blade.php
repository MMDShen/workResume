                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body px-0 pt-0 pb-2">
                            ...
                            <form class="m-auto w-75 justify-content-center d-flex flex-wrap gap-2"
                                  action="{{ url('food-party-table/') }}" method="POST">
                                @csrf
                                        ...
                                        @foreach($types as $type)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex px-2 py-1 justify-content-start">
                                                        <div class="d-flex flex-column justify-content-left">
                                                            <p class="mb-0 text-sm">{{$type->max}}</p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="d-flex px-2 py-1 justify-content-start">
                                                        <div class="d-flex flex-column justify-content-left">
                                                            <p class="mb-0 text-sm">{{$type->count}}</p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="d-flex px-2 py-1 justify-content-center">
                                                        <div class="d-flex px-2 py-1 justify-content-center">
                                                            ...
                                                            <div class="d-flex flex-column justify-content-center">
                                                                <a href="{{ url('/food-party-table/edit/'.$type->id) }}"
                                                ...
                                                <td>
                                                    <div class="d-flex px-2 py-1 justify-content-center">
                                                        ...
                                                        <form action="{{ url('food-party-table/'.$type->id) }}"
                                                              method="POST">
                                                            @csrf
                                                            @method('DELETE')
